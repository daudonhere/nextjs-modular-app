...
export function LinearLoadingComponent() {
  return (
    <AnimatedLoader className="absolute inset-0 flex items-center justify-center backdrop-blur-lg z-50">
      <ThreeDot color="#ffffff" size="small" />
    </AnimatedLoader>
  );
}

export function CircularLoadingComponent() {
  return (
    <AnimatedLoader>
